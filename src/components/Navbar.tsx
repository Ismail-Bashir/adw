      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          <Link href="/" className="flex items-center gap-2.5 group">
            <Image src="/logo.jpg" alt="ADW Logo" width={36} height={36} className="rounded-lg transition-transform group-hover:scale-105" />
          ...
          <div className="hidden md:flex items-center gap-1">
            ...
            <Link href="/contact" className="ml-3 inline-flex items-center rounded-lg bg-gradient-to-r from-accent to-accent-light px-5 py-2.5 text-sm font-bold text-black shadow-lg shadow-accent/20 hover:shadow-accent/40 transition-all hover:brightness-110">
              Get a Quote
            </Link>
          </div>
      ...
      {mobileOpen && (
        <div className="md:hidden border-t border-white/[0.06] bg-black/95 backdrop-blur-xl animate-fade-in">
          <div className="px-4 py-3 space-y-1">
            ...
            <Link href="/contact" onClick={() => setMobileOpen(false)} className="mt-2 block rounded-lg bg-gradient-to-r from-accent to-accent-light px-4 py-2.5 text-center text-sm font-bold text-black transition-colors">
              Get a Quote
            </Link>
          </div>
        </div>
