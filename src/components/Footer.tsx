      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 py-10 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href="/careers" className="text-sm text-white/30 hover:text-accent transition-colors flex items-center gap-1">Careers <ArrowUpRight className="h-3 w-3" /></Link></li>
