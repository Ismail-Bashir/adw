    ...
    <>
      <section className="relative bg-navy text-white py-24 sm:py-32">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative">
          <motion.div className="max-w-3xl" initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            ...
            <p className="text-lg text-white/50 leading-relaxed max-w-2xl">We provide end-to-end automation and design solutions tailored to your business.</p>
          </motion.div>
        </div>
          ...
          <div className="grid grid-cols-1 gap-20">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <ScrollReveal direction="left">
                ...
                <h2 className="text-3xl font-bold text-white mb-4">CAD Automation</h2>
                <p className="text-lg text-muted leading-relaxed mb-6">Automate repetitive CAD tasks and accelerate your design workflow with dynamic templates and smart scripts.</p>
                ...
                <Link href="/services/cad-automation" className="group inline-flex items-center gap-2 rounded-lg bg-gradient-to-r from-accent to-accent-light px-6 py-3 text-sm font-semibold text-navy hover:brightness-110 transition-all shadow-lg shadow-accent/20">
                  Learn More <ArrowRight className="h-4 w-4 group-hover:translate-x-1 transition-transform" />
                </Link>
              </ScrollReveal>
              <ScrollReveal direction="right" delay={0.2}>
                <div className="rounded-2xl bg-card p-10 border border-card-border">
                  <div className="space-y-4">
                    {[
                      ...
                      <motion.div key={stat.label} className="flex items-center justify-between p-4 rounded-xl bg-surface border border-border" whileHover={{ x: 5 }}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <ScrollReveal direction="right" className="order-1 lg:order-2">
                ...
                <h2 className="text-3xl font-bold text-white mb-4">Remote Design Group</h2>
                <p className="text-lg text-muted leading-relaxed mb-6">Enable efficient, off-site design work with tools that streamline communication and keep projects moving.</p>
                <ul className="space-y-3 mb-8">
                ...
                <Link href="/services/remote-design" className="group inline-flex items-center gap-2 rounded-lg bg-accent px-6 py-3 text-sm font-semibold text-black hover:brightness-110 transition-all shadow-lg shadow-accent/20">
                  Learn More <ArrowRight className="h-4 w-4 group-hover:translate-x-1 transition-transform" />
                </Link>
              </ScrollReveal>
            </div>
      ...
      <section className="py-24 sm:py-32 bg-surface">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          <ScrollReveal>
            <h2 className="text-3xl sm:text-4xl font-bold tracking-tight text-white mb-4">Not Sure Which Service Is Right for You?</h2>
            <p className="text-lg text-muted max-w-xl mx-auto mb-8">Let&apos;s talk through your needs.</p>
