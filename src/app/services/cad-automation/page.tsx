  ...
  return (
    <>
      <section className="relative bg-navy text-white py-16 sm:py-20">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_50%,rgba(14,165,233,0.06),transparent_60%)]" />
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative">
          <motion.div className="max-w-3xl" initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            ...
            <h1 className="text-3xl sm:text-4xl font-bold tracking-tight leading-[1.1] mb-4">CAD Automation</h1>
            <p className="text-base text-white/50 leading-relaxed max-w-2xl">Automate repetitive CAD tasks and accelerate your design workflow with dynamic templates and smart scripts.</p>
          </motion.div>
        </div>
      ...
      <section className="py-16 sm:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <ScrollReveal><div className="max-w-2xl mb-10"><p className="text-sm font-semibold uppercase tracking-widest text-accent mb-2">Our Work</p><h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-white mb-3">Real-World Automation</h2><p className="text-base text-muted leading-relaxed">Explore how we&apos;ve helped businesses automate and scale their CAD workflows.</p></div></ScrollReveal>
          ...
          <ScrollReveal delay={0.3}><div className="mt-10"><FloatingBlueprint /></div></ScrollReveal>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              { icon: FileOutput, title: "Automated Outputs", desc: "Generate ERP-integrated drawings, production files, reports, and BOMs directly in CAD.", color: "#7DD3FC" },
            ].map((f, i) => (
      ...
      <section className="py-14 sm:py-16 bg-surface">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          <ScrollReveal>
            ...
            <p className="text-base text-muted max-w-xl mx-auto mb-6">Let&apos;s build automation that saves your team hundreds of hours.</p>
