  ...
  return (
    <>
      <section className="relative bg-navy text-white py-24 sm:py-32">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_50%,rgba(212,160,23,0.06),transparent_60%)]" />
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative">
          <motion.div className="max-w-3xl" initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            ...
            <p className="text-lg text-white/50 leading-relaxed max-w-2xl">Enable efficient, off-site design work with tools that streamline communication, ensure consistency, and keep projects moving.</p>
          </motion.div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              { icon: FileOutput, title: "Automated Outputs", desc: "Instantly generate drawings, reports, and BOMs — directly within your CAD interface.", color: "#e6b800" },
            ].map((f, i) => (
